...
parameters FAC=0.6 TYPE=53 F0=50 TSTOP=20 TFAULT=2 SAMAN=0 PART=0 PAR=0 \
           PARLOAD=0 GFL_LIMITS=no GFL_PG=0+1*0.2 GFL_OFF=0

options outintnodes=yes  seed=19041962 topcheck=2 

AlL   alter group="ph3load" param="type" value=0 annotate=0
AlOff alter param="GFL_OFF" value=1 annotate=0

DcOff dc nettype=1 print=0 sparse=5 ireltol=1m iabstol=1u vreltol=1m \
      partitioner=(PART != NO && PART != 1) ? 3 : 0 parsolver=PAR 

AlOn alter param="GFL_OFF" value=0 annotate=0 invalidate=no

Dc dc nettype=1 print=0 sparse=5 ireltol=1m iabstol=1u vreltol=1m \
      partitioner=(PART != NO && PART != 1) ? 3 : 0 parsolver=PAR \
      restart=no

;Pz pz nettype=1 sparse=2+3 parsolver=yes pf=yes ; solver=1 tol=1u which=1

;PzMtrx control begin
;    save("mat5","./Pz.mat","M", get("Pz.invmtrx") );
;endcontrol

Tr tran nettype=1 stop=TSTOP partitioner=PART parsolver=PAR \
            acntrl=3 ltefactor=10k/10 \
            method=2 maxord=2 sparse=2+3 iabstol=1u vreltol=1m \
	    parload=PARLOAD devvars=yes \
	    tmin=1u tinc=0.5 saman=SAMAN damping=no \
	    keepmatrixorder=yes chgcheck=no \
	    annotate=6 \
	    ph3vars=yes \
	    savelist=["omega","bus34","ErrorP","ErrorI[dq]","ed","eq","DeltaE[dq]",
	    "SX2690941B","X[01-9]+.FI[01-9]+:[PQ]"]
//	    tmax=[TFAULT-2m,0.1m,TFAULT+20m,TFAULT+21m,1m,TFAULT+250m] \

;Jacobian control begin
;
;    save("mat5","./jac.mat","Jacobian", get("Tr.jacobian") );
;
;endcontrol
...
Fltd bus34:d  bus34:q  flt  FAULT COMMAND="Alo1 alter instance=Ln18 param=\"open\" value=1 invalidate=0" RFAULT=88/2+0*100/1

Flt  flt     gnd  vsource v1=0 v2=1 td=TFAULT tr=1u tf=1u width=200m period=TSTOP+1

model FAULT nport veriloga="fault.va"
...
// Stable with synchronous machines ot type 53 -- Unstable with synchronous machines of type 6
Ps16 pss16 gnd omega16   powerss  type=2 kw=20 tw=10 t1=0.2 t2=0.02 t3=0.4 t4=0.04 max=0.1 min=-0.1
Tg16 pm16   omega16      powertg type=1 r=1/10.0 ts=0.40 tc=75.0 t3=10.0 t4=2.4 t5=1.2 gen="G16"
...
// Stable with synchronous machines of type 6
;Ps16 pss16  gnd  omega16  powerss  type=2 kw=20 tw=10 t1=0.2 t2=0.02 t3=0.4 t4=0.04 max=0.1 min=-0.1
;Av16 bus16  ex16 pss16    poweravr type=1 vrating=20k ae=0 k0=200 tr=0 t1=0.04 t3=12 t2=1 te=0 vmax=6 vmin=-3
;G16  bus16  ex16 gnd omega16 powergenerator type=TYPE phtype=1 vg=1.0490 pg=2.6/4      prating=4G    vrating=20k \
;    xl=0.2 ra=0.0025 xd=0.90 xdp=0.27 xds=0.25 td0p=9.0  td0s=0.03 xq=0.60 xqp=0.27 xqs=0.25 tq0p=0.05 tq0s=0.05 h=2.80 d=0.5
...
Ln34 bus21  bus36   powerline r=0.00630/5      x=0.04428/5   b=0.29200/5     vrating=500e3 prating=100e6 trpar=0 print=1
...
Lo34 bus34 powerload pc=    70.000 qc=30.0000  prating=100M vrating=500k ap=2 aq=2 type=1
...
parameters VNOM_MV=7.2k*sqrt(2) VNOM_LV=120 SCALE_SL=1.0

begin power

subckt FeederCkt bus9052 coi nport=yes
    ...
    U6    ud9052   uq9052 tap9052  OLTC TW=20+10*rand() TC=100m
    ...
    Gx1     _HVMV_Sub_LSB     ph3gnd

parameter KREG=1.09

begin electrical

    T1ar    "regxfmr_190-8593:ar"   gnd   "190-8593:ar"   gnd transformer t1=1 t2=KREG trpar=no
    T1ai    "regxfmr_190-8593:ai"   gnd   "190-8593:ai"   gnd transformer t1=1 t2=KREG trpar=no
    T1br    "regxfmr_190-8593:br"   gnd   "190-8593:br"   gnd transformer t1=1 t2=KREG trpar=no
    T1bi    "regxfmr_190-8593:bi"   gnd   "190-8593:bi"   gnd transformer t1=1 t2=KREG trpar=no
    T1cr    "regxfmr_190-8593:cr"   gnd   "190-8593:cr"   gnd transformer t1=1 t2=KREG trpar=no
    T1ci    "regxfmr_190-8593:ci"   gnd   "190-8593:ci"   gnd transformer t1=1 t2=KREG trpar=no

    T2ar    "regxfmr_190-8581:ar"   gnd   "190-8581:ar"   gnd transformer t1=1 t2=KREG trpar=no
    T2ai    "regxfmr_190-8581:ai"   gnd   "190-8581:ai"   gnd transformer t1=1 t2=KREG trpar=no
    T2br    "regxfmr_190-8581:br"   gnd   "190-8581:br"   gnd transformer t1=1 t2=KREG trpar=no
    T2bi    "regxfmr_190-8581:bi"   gnd   "190-8581:bi"   gnd transformer t1=1 t2=KREG trpar=no
    T2cr    "regxfmr_190-8581:cr"   gnd   "190-8581:cr"   gnd transformer t1=1 t2=KREG trpar=no
    T2ci    "regxfmr_190-8581:ci"   gnd   "190-8581:ci"   gnd transformer t1=1 t2=KREG trpar=no

    T3ar    "regxfmr_190-7361:ar"   gnd   "190-7361:ar"   gnd transformer t1=1 t2=KREG trpar=no
    T3ai    "regxfmr_190-7361:ai"   gnd   "190-7361:ai"   gnd transformer t1=1 t2=KREG trpar=no
    T3br    "regxfmr_190-7361:br"   gnd   "190-7361:br"   gnd transformer t1=1 t2=KREG trpar=no
    T3bi    "regxfmr_190-7361:bi"   gnd   "190-7361:bi"   gnd transformer t1=1 t2=KREG trpar=no
    T3cr    "regxfmr_190-7361:cr"   gnd   "190-7361:cr"   gnd transformer t1=1 t2=KREG trpar=no
    T3ci    "regxfmr_190-7361:ci"   gnd   "190-7361:ci"   gnd transformer t1=1 t2=KREG trpar=no
...
parameter GFL_KD=2*pi*50 * 0.05 * 10

#ifdef ANGELO
    #include "8500/Angelo.inc"
#endif

#ifdef GFM
    #include "8500/Gfm.inc"
#endif

#ifdef DAVIDE
    #include "8500/GflDavide.inc"
#endif

#ifdef (! ANGELO) && (! GFM) && (! DAVIDE)
//    #include "8500/GflDavide.inc"
    #include "8500/Gfl.inc"
//    #include "8500/GflReducedNumber.inc"
#endif
...
#ifdef ANGELO
    model GFL   nport veriloga="angelo.va" verilogatrace=["P","Q","Wpll","Vq"]
    model GFM_FILTER nport veriloga="gfm.va" 
#endif

#ifdef GFM
    model GFM  nport veriloga="gfm.va" verilogatrace=["P","Q"]
    model GFM_FILTER nport veriloga="gfm.va" 
#endif

#ifdef DAVIDE
    model GFL nport veriloga="gflDavide.va" \
        verilogatrace=["P_PU","Q_PU","ErrorP","ErrorId","ErrorIq","DeltaEd","DeltaEq"]
#endif
...
X1   bus31 coi FeederCkt PRIM=500k
X2   bus32 coi FeederCkt PRIM=500k
X3   bus33 coi FeederCkt PRIM=500k
X4   bus34 coi FeederCkt PRIM=500k
X5   bus35 coi FeederCkt PRIM=500k
X6   bus36 coi FeederCkt PRIM=500k
X7   bus37 coi FeederCkt PRIM=500k
X8   bus38 coi FeederCkt PRIM=500k
X9   bus39 coi FeederCkt PRIM=500k
X10  bus40 coi FeederCkt PRIM=500k
X11  bus41 coi FeederCkt PRIM=482.81k

// 10 more 8500-feeders --> remove the ';' character

;Y1   bus17 coi FeederCkt PRIM=500k
;Y2   bus18 coi FeederCkt PRIM=500k
;Y3   bus19 coi FeederCkt PRIM=500k
;Y4   bus20 coi FeederCkt PRIM=500k
;Y5   bus21 coi FeederCkt PRIM=500k
;Y6   bus22 coi FeederCkt PRIM=500k
;Y7   bus23 coi FeederCkt PRIM=500k
;Y9   bus24 coi FeederCkt PRIM=230k
;Y10  bus25 coi FeederCkt PRIM=500k

end

model OLTC   nport veriloga="oltc.va" verilogaprotected=no \
...
model "3PH-Connector"                          ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-Connector"                          ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
...
model "3PH_H-2/0_ACSR2/0_ACSR2/0_ACSR2/0_ACSR" ph3line utype=1 raa= 0.632570 rab= 0.109951 rbb=0.627184 \
							       ...
							       ; baa= 8.345200 bab=-2.316010 bbb=8.720990 \
							       ; bac=-1.91256  bbc=-2.71715  bcc=8.57671
...
model "3PH_H-4_ACSR4_ACSR4_ACSR4_ACSR"         ph3line utype=1 raa= 1.683400 rab= 0.138324 rbb=1.676860 \
							       ...
							       ; baa= 7.600980 bab=-1.997510 bbb=7.888110
							       ; bac=-1.667970 bbc=-2.324890 bcc=7.780370

model "3PH_H-2/0_ACSR2/0_ACSR2/0_ACSR2_ACSR"   ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-2/0_ACSR2/0_ACSR2/0_ACSR2_WPAL"   ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-2/0_ACSR2/0_ACSR2/0_ACSR4_ACSR"   ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-2_ACSR2_ACSR2_ACSR2_ACSR"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-2_ACSR2_ACSR4_ACSR4_ACSR"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-397_ACSR397_ACSR397_ACSR2/0_ACSR" ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-397_ACSR397_ACSR397_ACSR2/0_WPAL" ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-397_ACSR397_ACSR397_ACSR397_ACSR" ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-397_ACSR397_ACSR397_ACSR4_WPAL"   ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_ACSR2_ACSR2_ACSR4_ACSR"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_ACSR2_ACSR2_ACSR4_WPAL"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_ACSR4_ACSR4_ACSR2_WPAL"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_ACSR4_ACSR4_ACSR4_TPX"          ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_ACSR4_ACSR4_ACSR4_WPAL"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_WPAL4_WPAL4_WPAL4_WPAL"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_WPAL4_WPAL4_WPAL1/0_TPX"        ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "3PH_H-4_WPAL4_WPAL4_WPAL4_ACSR"         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1P_1/0_AXNJ_DB"                         ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2/0_ACSRxx2_ACSR"                   ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2_ACSRxx1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2_ACSRxx2_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2_ACSRxx4/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2_ACSRxx4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2_ACSRxx4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-2_WPALxx2_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_ACSRxx1/0_3W_CS"                  ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_ACSRxx1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_ACSRxx2_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_ACSRxx4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_ACSRxx4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_ACSRxx6_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_WPALxx1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_WPALxx2_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_WPALxx4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-4_WPALxx4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x2_ACSRx1/0_3W_CS"                  ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x2_ACSRx1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x2_ACSRx2_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x2_ACSRx4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x2_ACSRx4_TPX"                      ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx1/0_3W_CS"                  ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx2_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx4_DPX"                      ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx4_TPX"                      ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_ACSRx4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_WPALx1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_WPALx2_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_WPALx4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-x4_WPALx4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx2/0_ACSR1/0_TPX"                  ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx2_ACSR1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx2_ACSR2_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx2_ACSR4_DPX"                      ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_ACSR1/0_ACSR"                   ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_ACSR1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_ACSR2_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_ACSR4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_ACSR4_TPX"                      ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_ACSR4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_WPAL1/0_TPX"                    ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_WPAL4_ACSR"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx4_WPAL4_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "1PH-xx6_WPAL6_WPAL"                     ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
model "2PH_H-2_ACSRx2_ACSR2_ACSR"              ph3line utype=1 rph=0.501 xph=0.716 r0=0.817 x0=1.598 ; b0=47.483u
...
model "4/0Triplex"      ph3line utype=1 raa= 0.40995115 rab= 0.11809509 \
					...
					; caa= 3.00000000  cba=-2.40000000
					; cab=-2.40000000  cbb= 3.00000000
...
model "750_Triplex"     ph3line utype=1 raa=0.04974733 rab=0.02342157 \
					...
					; caa= 3.00000000  cab=-2.40000000
					; cba=-2.40000000  cbb= 3.00000000
